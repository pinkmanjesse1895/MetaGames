...
contract MetaGames is BEP20, Pausable, BEP20Detailed {
    ...
    constructor() public BEP20Detailed("MetaGames", "MTG", 9) {
        totalCoins = 20000000000 * 10**uint256(decimals());
        _mint(owner(), totalCoins); // total supply fixed at 20 billion tokens
    }
